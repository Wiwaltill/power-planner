...
$checks[] = check_row('App-Version', true, 'Installiert: ' . APP_VERSION);
...
<main class="container py-4 flex-grow-1">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div><h1 class="h3 mb-1">Systemcheck</h1><div class="small-muted">Prüft Server, Schreibrechte und Grundvoraussetzungen.</div></div>
