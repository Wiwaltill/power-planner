...
<main class="container py-4 flex-grow-1">
  <div class="row g-4">
    ...
    </form><hr><div class="d-flex gap-2"><button class="btn btn-outline-secondary btn-sm flex-fill" id="exportDevices" type="button">Export</button><button class="btn btn-outline-success btn-sm flex-fill" id="importDevices" type="button">JSON Import</button><button class="btn btn-outline-success btn-sm flex-fill" id="importDevicesCsv" type="button">CSV Import</button><input class="d-none" id="importDevicesFile" type="file" accept=".json,application/json"><input class="d-none" id="importDevicesCsvFile" type="file" accept=".csv,text/csv"></div></div></div>
