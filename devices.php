...
<main class="container py-4 flex-grow-1">
  <div class="row g-4">
    ...
    </form><hr><div class="d-flex gap-2"><button class="btn btn-outline-secondary btn-sm flex-fill" id="exportDevices" type="button">JSON Export</button><a class="btn btn-outline-secondary btn-sm flex-fill" href="<?= e(app_url('api/devices?csv_export=1')) ?>">CSV Export</a><button class="btn btn-outline-success btn-sm flex-fill" id="importDevices" type="button">JSON Import</button><button class="btn btn-outline-success btn-sm flex-fill" id="importDevicesCsv" type="button">CSV Import</button><a class="btn btn-outline-info btn-sm flex-fill" href="<?= e(app_url('api/devices?csv_template=1')) ?>">CSV Vorlage</a><input class="d-none" id="importDevicesFile" type="file" accept=".json,application/json"><input class="d-none" id="importDevicesCsvFile" type="file" accept=".csv,text/csv"></div></div></div>
  ...
  <div class="card p-4 mt-4"><h2 class="h4 mb-3"><i class="bi bi-trash me-2"></i>Geräte-Papierkorb</h2><div class="table-responsive"><table class="table align-middle"><thead><tr><th>Gerät</th><th>Leistung</th><th class="text-end">Aktion</th></tr></thead><tbody id="deviceTrashRows"></tbody></table></div></div>
</main>
