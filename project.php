  ...
  <div class="tab-content">
    <section class="tab-pane fade show active" id="tab-overview">
      <div class="row g-4">
        ...
        <div class="col-lg-5"><div class="card p-4 h-100"><h2 class="h4 mb-3"><i class="bi bi-bar-chart-line me-2"></i>Projektkennzahlen</h2><div class="row g-3"><div class="col-6"><div class="metric-card"><span>Stromkreise</span><strong id="metricCircuits">–</strong></div></div><div class="col-6"><div class="metric-card"><span>Gerätepositionen</span><strong id="metricItems">–</strong></div></div><div class="col-6"><div class="metric-card"><span>Gesamtleistung</span><strong id="metricWatts">–</strong></div></div><div class="col-6"><div class="metric-card"><span>Max. Phase</span><strong id="metricMaxPhase">–</strong></div></div></div><div id="metricPhaseBalance" class="mt-3 small-muted"></div></div></div>
      </div>
    </section>
